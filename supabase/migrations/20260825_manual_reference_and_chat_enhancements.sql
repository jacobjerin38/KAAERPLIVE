-- Migration: Manual Reference Number Encoding & Chat Enhancements
-- Date: 2026-08-25

-- 1. Add reference_code and code to accounting_partners for custom customer/vendor ledger reference encoding
ALTER TABLE public.accounting_partners 
ADD COLUMN IF NOT EXISTS reference_code TEXT,
ADD COLUMN IF NOT EXISTS code TEXT;

-- 2. Update rpc_create_accounting_invoice to support p_reference
...
BEGIN
    ...
    -- 2. Create Header (Draft State) in accounting_journal_entries with manual reference
...
-- 3. Update rpc_update_accounting_invoice to support p_reference
...
BEGIN
    ...
    -- Update Header including manual reference
